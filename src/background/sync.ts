...
/**
 * Markers that identify an index this extension wrote. The former name is
 * still recognised so a repository set up before the rename keeps its
 * README.md instead of suddenly being treated as someone else's file.
 */
const INDEX_MARKERS = ['Generated by Smriti', 'Generated by DSA Revision Buddy'];
